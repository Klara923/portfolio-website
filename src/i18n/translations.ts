...
const en = {
  ...
  hero: {
    ...
    frontendFocus: ", with a strong focus on frontend development.",
...
const pl = {
  ...
  hero: {
    ...
    paragraph2Thinking: "i podejściu user-centered.",
    paragraph3Intro: "Mieszkam w Polsce i jestem otwarta na",
    paragraph3Opportunities: "pracę zdalną, hybrydową i możliwości za granicą",
    paragraph3End: ".",
  },
  sections: {
    ...
    languagesDescription: "Języki, w których pracuję i komunikuję się na co dzień.",
